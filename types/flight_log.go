...
type MissionDBO struct {
	ID               uuid.UUID  `json:"id"`
	FlightLogID      uuid.UUID  `json:"flight_log_id"`
	MissionNumber    string     `json:"mission_number"`
	...
	LandTime         *time.Time `json:"land_time"`
	TotalTimeDecimal int64      `json:"total_time_decimal"`
...
type MissionDTO struct {
	...
	TotalTimeDecimal int64      `json:"total_time_decimal,omitempty"`
